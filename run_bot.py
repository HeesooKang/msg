...
def get_strategy():
    ...
    strategy_config = MomentumScalpConfig(
        ...
        neutral_capital_utilization_pct=0.20,   # 중립장: 총노출 20%
        ...
        neutral_pullback_min_drop_pct=0.70,
        neutral_pullback_max_drop_pct=1.4,
        neutral_pullback_min_ticks=2,
        neutral_min_runup_from_open_pct=1.6,
        neutral_reclaim_buffer_pct=0.10,        # 이전 고점 0.10% 상향 재돌파 확인
        neutral_chase_block_proximity_pct=0.40,
        neutral_entry_start_minutes_after_open=35,
        neutral_entry_confirmation_ticks=3,
